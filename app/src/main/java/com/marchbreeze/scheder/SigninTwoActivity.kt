...
import com.marchbreeze.scheder.databinding.ActivitySigninTwoBinding
import java.util.concurrent.TimeUnit

class SigninTwoActivity : AppCompatActivity() {

    private lateinit var binding: ActivitySigninTwoBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivitySigninTwoBinding.inflate(layoutInflater)
        ...
        mCallBacks = object : PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
            ...
            override fun onVerificationFailed(e: FirebaseException) {
                ...
                Toast.makeText(this@SigninTwoActivity, "${e.message}", Toast.LENGTH_SHORT).show()
            }
        ...
        binding.btnPhonenumber.setOnClickListener {
            // input 전화번호
            val phone = "+8210" + binding.edittextPhonenumber.text.toString().trim()
            // 전화번호 인증 절차
